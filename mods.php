<?php
    ...
    $modList = ["FlatView", "HiddenLogin", "TopNav", "SquareSearch", "NoBgColorOnHover", "RoundCards", "BiggerIcons", "DarkestMode", "SimplerCallouts", "ComplimentIcons", "BoldButtons", "FullOpacity"];
?>
